...
namespace ZombieTweak2.zRootBotPlayerAction.BaseActionWrappers
{
    internal class zRootPlayerBotAction : RootPlayerBotAction
    {
        public zRootPlayerBotAction(Descriptor desc) : base(desc)
        {
            ...
            //data.customActions.Add(m_idleAction); // Add it to our custom list
            //// Repeat
            ...
            //data.customActions.Add(m_followLeaderAction);
            ...
            //data.customActions.Add(m_useBioscanAction);
            ...
            //data.customActions.Add(m_attackAction);
            ...
            //data.customActions.Add(m_reviveAction);
            ...
            //data.customActions.Add(m_unlockAction);
            ...
            //data.customActions.Add(m_highlightAction);
            ...
            //data.customActions.Add(m_useEnemyScannerAction);
            ...
            //data.customActions.Add(m_tagEnemiesAction);
            ...
            //data.customActions.Add(m_collectItemAction);
            ...
            //data.customActions.Add(m_shareResourceAction);
            ...
            //data.customActions.Add(m_evadeAction);

            //var m_exploreAction = new CustomActions.exploreDescriptor(this.m_bot);
