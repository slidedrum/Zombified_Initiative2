...
namespace ZombieTweak2.zRootBotPlayerAction
{
    ...
    public static class zActions
    {
        ...
        public static void RegisterStrictTypeInstance(PlayerBotActionBase.Descriptor strictDescType)
        {
        ...
        public static void RegisterStrictTypeInstance(PlayerBotActionBase strictActType)
        {
